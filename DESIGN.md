...
| 1 hour | `SYNC_SCRATCH_MAX_AGE=3600` | Scratch counts as abandoned | A suite run cannot outlive its own ceiling, which is also 1 hour since #152, and 600x the 6 second sync, proved by #36 | 2026-08-22 |
