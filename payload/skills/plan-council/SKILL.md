...
- **Check the lessons audit next.** The workflow audits the plan against the lessons index files and tries to correct violations inline, same as the reality-check. Read `lessonsAudit`:
...
## 5. Offer a tracking milestone  (user)
