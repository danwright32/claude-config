...
Usage:
    uv run generate_image.py --prompt "your image description" --filename "output.png" [--resolution 0.5K|1K|2K|4K] [--aspect-ratio 16:9] [--api-key KEY]
"""
...
def main():
    ...
    parser.add_argument(
        ...
        default=None,
        help="Aspect ratio (e.g., 16:9, 1:1, 3:2). Default: let API decide"
    )
    parser.add_argument(
        "--grounding", "-g",
        action="store_true",
        help="Enable Google Image Search grounding for more accurate depictions"
    )
    parser.add_argument(
        "--api-key", "-k",
    ...
    # Build tools list for grounding
    tools = None
    if args.grounding:
        tools = [
