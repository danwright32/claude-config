...
reason = (
    ...
    "done, so its title NAMES the feature in at most 6 words: Saved views, Salesforce sync v2, Queue "
    "windowing. Never a narrative sentence, and never a category like Accessibility (categories are "
