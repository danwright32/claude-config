...
LESSONS.md, which is NOT loaded into the session. 183 lessons.
...
- L184. A durable record that exists to stop an action repeating is only as durable as its KEY.
